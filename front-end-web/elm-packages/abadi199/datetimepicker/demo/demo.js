...
var _abadi199$datepicker$DateTimePicker_ClockUtils$minutes = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$map,
		function (minute) {
			return {
		...
		A2(_elm_lang$core$List$range, 0, 59)));
var _abadi199$datepicker$DateTimePicker_ClockUtils$minutesPerFive = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
...
var _abadi199$datepicker$DateTimePicker_ClockUtils$hours = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
...
var _abadi199$datepicker$DateTimePicker_ClockUtils$minuteToAngle = function (minute) {
	return A2(
		_elm_lang$core$Dict$get,
		_elm_lang$core$Basics$toString(minute),
		_abadi199$datepicker$DateTimePicker_ClockUtils$minutes);
};
var _abadi199$datepicker$DateTimePicker_ClockUtils$hourToAngle = function (hour) {
	return A2(
		_elm_lang$core$Dict$get,
		_elm_lang$core$Basics$toString(hour),
		_abadi199$datepicker$DateTimePicker_ClockUtils$hours);
};

var _abadi199$datepicker$DateTimePicker_DateUtils$toMillitary = F2(
	function (hour, amPm) {
...
var _abadi199$datepicker$DateTimePicker_DateUtils$fromMillitaryAmPm = function (hour) {
	var _p1 = hour;
	switch (_p1) {
		case 12:
			return 'PM';
...
var _abadi199$datepicker$DateTimePicker_DateUtils$fromMillitaryHour = function (hour) {
	var _p2 = hour;
	switch (_p2) {
		case 12:
			return 12;
...
var _abadi199$datepicker$DateTimePicker_DateUtils$padding = function (str) {
	return _elm_lang$core$Native_Utils.eq(
...
var _abadi199$datepicker$DateTimePicker_DateUtils$setTime = F4(
	function (date, hour, minute, amPm) {
		return A7(
			...
			_elm_lang$core$Date$month(date),
			_elm_lang$core$Date$day(date),
			A2(_abadi199$datepicker$DateTimePicker_DateUtils$toMillitary, hour, amPm),
			minute,
			0,
			0);
	});
var _abadi199$datepicker$DateTimePicker_DateUtils$toTime = F3(
...
var _abadi199$datepicker$DateTimePicker_DateUtils$toDateTime = F5(
...
var _abadi199$datepicker$DateTimePicker_DateUtils$toDate = F3(
	function (year, month, day) {
		return A5(_abadi199$datepicker$DateTimePicker_DateUtils$toDateTime, year, month, day, 0, 0);
	});
var _abadi199$datepicker$DateTimePicker_DateUtils$calculateNumberOfDaysForPreviousMonth = function (firstDayInInt) {
	return _elm_lang$core$Native_Utils.eq(firstDayInInt, 0) ? 7 : firstDayInInt;
};
var _abadi199$datepicker$DateTimePicker_DateUtils$dayToInt = F2(
...
var _abadi199$datepicker$DateTimePicker_DateUtils$Day = F2(
	function (a, b) {
		return {monthType: a, day: b};
	});
var _abadi199$datepicker$DateTimePicker_DateUtils$Next = {ctor: 'Next'};
var _abadi199$datepicker$DateTimePicker_DateUtils$Current = {ctor: 'Current'};
var _abadi199$datepicker$DateTimePicker_DateUtils$Previous = {ctor: 'Previous'};
var _abadi199$datepicker$DateTimePicker_DateUtils$generateCalendar = F3(
	function (firstDayOfWeek, month, year) {
		var nextMonth = A2(
			_elm_lang$core$List$map,
			_abadi199$datepicker$DateTimePicker_DateUtils$Day(_abadi199$datepicker$DateTimePicker_DateUtils$Next),
		...
		var firstDayOfMonth = A2(
			_abadi199$datepicker$DateTimePicker_DateUtils$dayToInt,
			firstDayOfWeek,
			_elm_lang$core$Date$dayOfWeek(firstDateOfMonth));
		var numberOfDaysForPreviousMonth = _abadi199$datepicker$DateTimePicker_DateUtils$calculateNumberOfDaysForPreviousMonth(firstDayOfMonth);
		var daysInMonth = _rluiten$elm_date_extra$Date_Extra_Core$daysInMonthDate(firstDateOfMonth);
		var currentMonth = A2(
			_elm_lang$core$List$map,
			_abadi199$datepicker$DateTimePicker_DateUtils$Day(_abadi199$datepicker$DateTimePicker_DateUtils$Current),
		...
		var previousMonth = A2(
			_elm_lang$core$List$map,
			_abadi199$datepicker$DateTimePicker_DateUtils$Day(_abadi199$datepicker$DateTimePicker_DateUtils$Previous),
...
var _abadi199$datepicker$DateTimePicker_Events$touches = function (decoder) {
	var loop = F2(
		function (idx, xs) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
...
var _abadi199$datepicker$DateTimePicker_Events$onTouchMovePreventDefault = function (msg) {
...
var _abadi199$datepicker$DateTimePicker_Events$onPointerUp = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'pointerup',
		_elm_lang$core$Json_Decode$succeed(msg));
};
var _abadi199$datepicker$DateTimePicker_Events$onTouchEndPreventDefault = function (msg) {
	var eventOptions = {preventDefault: true, stopPropagation: true};
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'touchend',
...
var _abadi199$datepicker$DateTimePicker_Events$onMouseUpPreventDefault = function (msg) {
	var eventOptions = {preventDefault: true, stopPropagation: true};
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mouseup',
...
var _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault = function (msg) {
	var eventOptions = {preventDefault: true, stopPropagation: true};
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'touchstart',
...
var _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault = function (msg) {
	var eventOptions = {preventDefault: true, stopPropagation: true};
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mousedown',
...
var _abadi199$datepicker$DateTimePicker_Events$onBlurWithChange = F2(
...
var _abadi199$datepicker$DateTimePicker_Events$MoveData = F2(
	function (a, b) {
		return {offsetX: a, offsetY: b};
	});
var _abadi199$datepicker$DateTimePicker_Events$mouseMoveDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_abadi199$datepicker$DateTimePicker_Events$MoveData,
	A2(
		_elm_lang$core$Json_Decode$map,
...
var _abadi199$datepicker$DateTimePicker_Events$onMouseMoveWithPosition = function (decoder) {
	return A2(
		_elm_lang$svg$Svg_Events$on,
		'mousemove',
		A2(_elm_lang$core$Json_Decode$andThen, decoder, _abadi199$datepicker$DateTimePicker_Events$mouseMoveDecoder));
};
var _abadi199$datepicker$DateTimePicker_Events$onPointerMoveWithPosition = function (decoder) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'pointermove',
		A2(_elm_lang$core$Json_Decode$andThen, decoder, _abadi199$datepicker$DateTimePicker_Events$mouseMoveDecoder));
...
var _abadi199$datepicker$DateTimePicker_Geometry$calculateArrowPoint = F3(
...
var _abadi199$datepicker$DateTimePicker_Geometry$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _abadi199$datepicker$DateTimePicker_Geometry$Quadrant4 = {ctor: 'Quadrant4'};
var _abadi199$datepicker$DateTimePicker_Geometry$Quadrant3 = {ctor: 'Quadrant3'};
var _abadi199$datepicker$DateTimePicker_Geometry$Quadrant2 = {ctor: 'Quadrant2'};
var _abadi199$datepicker$DateTimePicker_Geometry$Quadrant1 = {ctor: 'Quadrant1'};
var _abadi199$datepicker$DateTimePicker_Geometry$calculateAngle = F3(
	function (p1, p2, p3) {
		...
		var quadrant = ((_elm_lang$core$Native_Utils.cmp(p3.x, p1.x) > -1) && (_elm_lang$core$Native_Utils.cmp(p3.y, p1.y) > -1)) ? _abadi199$datepicker$DateTimePicker_Geometry$Quadrant1 : (((_elm_lang$core$Native_Utils.cmp(p3.x, p1.x) < 0) && (_elm_lang$core$Native_Utils.cmp(p3.y, p1.y) > -1)) ? _abadi199$datepicker$DateTimePicker_Geometry$Quadrant2 : (((_elm_lang$core$Native_Utils.cmp(p3.x, p1.x) < 0) && (_elm_lang$core$Native_Utils.cmp(p3.y, p1.y) < 0)) ? _abadi199$datepicker$DateTimePicker_Geometry$Quadrant3 : _abadi199$datepicker$DateTimePicker_Geometry$Quadrant4));
		var _p0 = quadrant;
		switch (_p0.ctor) {
			case 'Quadrant3':
				return angle;
...
var _abadi199$datepicker$DateTimePicker_Internal$Time = F3(
	function (a, b, c) {
		return {hour: a, minute: b, amPm: c};
	});
var _abadi199$datepicker$DateTimePicker_Internal$InternalState = function (a) {
	return {ctor: 'InternalState', _0: a};
};
var _abadi199$datepicker$DateTimePicker_Internal$AMPMIndicator = {ctor: 'AMPMIndicator'};
var _abadi199$datepicker$DateTimePicker_Internal$MinuteIndicator = {ctor: 'MinuteIndicator'};
var _abadi199$datepicker$DateTimePicker_Internal$HourIndicator = {ctor: 'HourIndicator'};
var _abadi199$datepicker$DateTimePicker_Internal$initialState = _abadi199$datepicker$DateTimePicker_Internal$InternalState(
	{
		inputFocused: false,
		forceClose: false,
		event: '',
		...
		time: A3(_abadi199$datepicker$DateTimePicker_Internal$Time, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing),
		hourPickerStart: 1,
		minutePickerStart: 0,
		currentAngle: _elm_lang$core$Maybe$Nothing,
		activeTimeIndicator: _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$HourIndicator)
	});
var _abadi199$datepicker$DateTimePicker_Internal$initialStateWithToday = function (today) {
	return _abadi199$datepicker$DateTimePicker_Internal$InternalState(
		{
			inputFocused: false,
			forceClose: false,
			event: '',
...
var _abadi199$datepicker$AnalogTimePickerPanel$updateTimeIndicator = F2(
			...
			switch (_p0._0._0.ctor) {
				case 'HourIndicator':
					if (_p0._2.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$MinuteIndicator);
					} else {
						if (_p0._3.ctor === 'Nothing') {
							return _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$AMPMIndicator);
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					}
				case 'MinuteIndicator':
					if (_p0._3.ctor === 'Nothing') {
						...
						if (_p0._1.ctor === 'Nothing') {
							return _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$HourIndicator);
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					}
...
var _abadi199$datepicker$AnalogTimePickerPanel$updateCurrentDate = function (_p1) {
	var _p2 = _p1;
	var _p4 = _p2._0;
	...
	if ((((_p3.ctor === '_Tuple3') && (_p3._0.ctor === 'Just')) && (_p3._1.ctor === 'Just')) && (_p3._2.ctor === 'Just')) {
		return _elm_lang$core$Maybe$Just(
			A3(_abadi199$datepicker$DateTimePicker_DateUtils$toTime, _p3._0._0, _p3._1._0, _p3._2._0));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _abadi199$datepicker$AnalogTimePickerPanel$amPmPickerHandler = F4(
	function (config, _p5, currentDate, amPm) {
		...
		var updatedState = _abadi199$datepicker$DateTimePicker_Internal$InternalState(
			_elm_lang$core$Native_Utils.update(
				_p7,
				{
					time: updatedTime,
					activeTimeIndicator: A2(_abadi199$datepicker$AnalogTimePickerPanel$updateTimeIndicator, _p7.activeTimeIndicator, updatedTime)
				}));
		return A2(
			config.onChange,
			updatedState,
			_abadi199$datepicker$AnalogTimePickerPanel$updateCurrentDate(updatedState));
	});
var _abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler = F4(
	function (config, _p8, currentDate, timeIndicator) {
				...
				switch (_p10._0.ctor) {
					case 'HourIndicator':
						if (_p10._1.ctor === 'Just') {
							return _abadi199$datepicker$DateTimePicker_ClockUtils$hourToAngle(_p10._1._0);
						} else {
							break _v5_2;
						}
					case 'MinuteIndicator':
						if (_p10._2.ctor === 'Just') {
							return _abadi199$datepicker$DateTimePicker_ClockUtils$minuteToAngle(_p10._2._0);
						} else {
							break _v5_2;
						}
					default:
		...
		return A2(
			config.onChange,
			_abadi199$datepicker$DateTimePicker_Internal$InternalState(updatedState),
			currentDate);
	});
var _abadi199$datepicker$AnalogTimePickerPanel$mouseDownHandler = F3(
	function (_p12, date, onChange) {
		...
		var updatedState = _abadi199$datepicker$DateTimePicker_Internal$InternalState(
			_elm_lang$core$Native_Utils.update(
				_p14,
				{
					activeTimeIndicator: A2(_abadi199$datepicker$AnalogTimePickerPanel$updateTimeIndicator, _p14.activeTimeIndicator, _p14.time)
				}));
		var updatedDate = _abadi199$datepicker$AnalogTimePickerPanel$updateCurrentDate(
			_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p14));
		return A2(onChange, updatedState, updatedDate);
	});
var _abadi199$datepicker$AnalogTimePickerPanel$drawArrow = F4(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
											A3(_abadi199$datepicker$AnalogTimePickerPanel$mouseDownHandler, state, date, onChange)),
										_1: {
											ctor: '::',
											_0: _abadi199$datepicker$DateTimePicker_Events$onPointerUp(
												A3(_abadi199$datepicker$AnalogTimePickerPanel$mouseDownHandler, state, date, onChange)),
											_1: {ctor: '[]'}
										}
									}
...
var _abadi199$datepicker$AnalogTimePickerPanel$axisPoint = A2(_abadi199$datepicker$DateTimePicker_Geometry$Point, 200, 100);
var _abadi199$datepicker$AnalogTimePickerPanel$originPoint = A2(_abadi199$datepicker$DateTimePicker_Geometry$Point, 100, 100);
var _abadi199$datepicker$AnalogTimePickerPanel$updateHourState = F3(
	function (_p15, date, moveData) {
		...
		var currentAngle = A3(
			_abadi199$datepicker$DateTimePicker_Geometry$calculateAngle,
			_abadi199$datepicker$AnalogTimePickerPanel$originPoint,
			_abadi199$datepicker$AnalogTimePickerPanel$axisPoint,
			A2(_abadi199$datepicker$DateTimePicker_Geometry$Point, moveData.offsetX, moveData.offsetY));
		var closestHour = A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Tuple$first,
			_elm_lang$core$List$head(
				A2(
					...
					A2(
						...
						_elm_lang$core$Dict$toList(_abadi199$datepicker$DateTimePicker_ClockUtils$hours)))));
		return _abadi199$datepicker$DateTimePicker_Internal$InternalState(
			_elm_lang$core$Native_Utils.update(
				_p21,
				{
...
var _abadi199$datepicker$AnalogTimePickerPanel$updateMinuteState = F3(
			...
			_elm_lang$core$List$head(
				A2(
					...
					A2(
						...
						_elm_lang$core$Dict$toList(_abadi199$datepicker$DateTimePicker_ClockUtils$minutes)))));
		return _abadi199$datepicker$DateTimePicker_Internal$InternalState(
			_elm_lang$core$Native_Utils.update(
				_p28,
				{
...
var _abadi199$datepicker$AnalogTimePickerPanel$mouseOverHandler = F4(
			...
			if (_p31.ctor === 'Just') {
				switch (_p31._0.ctor) {
					case 'HourIndicator':
						return decoder(
							A3(
								_abadi199$datepicker$AnalogTimePickerPanel$updateHourState,
								_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p32),
								date,
								moveData));
					case 'MinuteIndicator':
						return decoder(
							A3(
								_abadi199$datepicker$AnalogTimePickerPanel$updateMinuteState,
								_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p32),
								date,
								moveData));
					default:
...
var _abadi199$datepicker$AnalogTimePickerPanel$clockFace = F4(
	function (onChange, state, date, _p33) {
		var _p34 = _p33;
		var point = A3(_abadi199$datepicker$DateTimePicker_Geometry$calculateArrowPoint, _abadi199$datepicker$AnalogTimePickerPanel$originPoint, 85, _p34._1);
		return A2(
...
var _abadi199$datepicker$AnalogTimePickerPanel$minuteArrowLength = 70;
var _abadi199$datepicker$AnalogTimePickerPanel$currentTime = F3(
		...
		var drawMinute = function (minute) {
			return A2(
				...
				A2(
					...
					function (_p37) {
						return A4(
							_abadi199$datepicker$AnalogTimePickerPanel$drawArrow,
							onChange,
							_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p41),
							date,
							A3(_abadi199$datepicker$DateTimePicker_Geometry$calculateArrowPoint, _abadi199$datepicker$AnalogTimePickerPanel$originPoint, _abadi199$datepicker$AnalogTimePickerPanel$minuteArrowLength, _p37));
					},
					A2(
						_elm_lang$core$Dict$get,
						_elm_lang$core$Basics$toString(minute),
					...
					A2(
						...
						function (_p38) {
							return A4(
								...
								_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p41),
								date,
								A3(_abadi199$datepicker$DateTimePicker_Geometry$calculateArrowPoint, _abadi199$datepicker$AnalogTimePickerPanel$originPoint, hourArrowLength, _p38));
						},
						A2(
							_elm_lang$core$Maybe$map,
							A2(
...
var _abadi199$datepicker$AnalogTimePickerPanel$hourArrowLength = 50;
var _abadi199$datepicker$AnalogTimePickerPanel$arrow = F3(
	function (onChange, _p42, date) {
		...
		var length = function () {
			...
			do {
				if (_p46.ctor === 'Just') {
					switch (_p46._0.ctor) {
						case 'HourIndicator':
							return _abadi199$datepicker$AnalogTimePickerPanel$hourArrowLength;
						case 'MinuteIndicator':
							return _abadi199$datepicker$AnalogTimePickerPanel$minuteArrowLength;
						default:
							break _v19_2;
					}
				} else {
		...
		var arrowPoint = function (angle) {
			return A3(_abadi199$datepicker$DateTimePicker_Geometry$calculateArrowPoint, _abadi199$datepicker$AnalogTimePickerPanel$originPoint, length, angle);
		};
		...
		if (_p47.ctor === 'Nothing') {
			...
			return shouldDrawArrow ? A4(
				_abadi199$datepicker$AnalogTimePickerPanel$drawArrow,
				onChange,
				_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p48),
				date,
				arrowPoint(_p47._0)) : _elm_lang$html$Html$text('');
		}
	});
var _abadi199$datepicker$AnalogTimePickerPanel$clock = F3(
	function (onChange, _p49, date) {
		var _p50 = _p49;
		var _p52 = _p50;
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerAnalogClock'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
													A3(_abadi199$datepicker$AnalogTimePickerPanel$mouseDownHandler, _p52, date, onChange)),
												_1: {
													ctor: '::',
													_0: _abadi199$datepicker$DateTimePicker_Events$onPointerUp(
														A3(_abadi199$datepicker$AnalogTimePickerPanel$mouseDownHandler, _p52, date, onChange)),
													_1: {
														ctor: '::',
														_0: _abadi199$datepicker$DateTimePicker_Events$onMouseMoveWithPosition(
															A3(_abadi199$datepicker$AnalogTimePickerPanel$mouseOverHandler, _p52, date, onChange)),
														_1: {
															ctor: '::',
															_0: _abadi199$datepicker$DateTimePicker_Events$onTouchMovePreventDefault(
																A2(onChange, _p52, date)),
															_1: {
																ctor: '::',
																_0: _abadi199$datepicker$DateTimePicker_Events$onPointerMoveWithPosition(
																	A3(_abadi199$datepicker$AnalogTimePickerPanel$mouseOverHandler, _p52, date, onChange)),
																_1: {ctor: '[]'}
															}
														}
						...
						_1: {
							...
							_0: function () {
								...
								if ((_p51.ctor === 'Just') && (_p51._0.ctor === 'MinuteIndicator')) {
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A3(_abadi199$datepicker$AnalogTimePickerPanel$clockFace, onChange, _p52, date),
											_elm_lang$core$Dict$toList(_abadi199$datepicker$DateTimePicker_ClockUtils$minutesPerFive)));
								} else {
									return A2(
										_elm_lang$svg$Svg$g,
										{ctor: '[]'},
							...
							_1: {
								ctor: '::',
								_0: A3(_abadi199$datepicker$AnalogTimePickerPanel$arrow, onChange, _p52, date),
								_1: {
									ctor: '::',
									_0: A3(_abadi199$datepicker$AnalogTimePickerPanel$currentTime, onChange, _p52, date),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _abadi199$datepicker$AnalogTimePickerPanel$view = F3(
	function (config, _p53, currentDate) {
		...
		var amPmPicker = function (config) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerAMPMPicker'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
								A4(_abadi199$datepicker$AnalogTimePickerPanel$amPmPickerHandler, config, _p60, currentDate, 'AM')),
							_1: {
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
									A4(_abadi199$datepicker$AnalogTimePickerPanel$amPmPickerHandler, config, _p60, currentDate, 'AM')),
								_1: {
									ctor: '::',
									_0: function () {
										...
										if ((_p55.ctor === 'Just') && (_p55._0 === 'AM')) {
											return _elm_lang$html$Html_Attributes$class('elm-input-datepickerAM elm-input-datepickerSelectedAmPm');
										} else {
											return _elm_lang$html$Html_Attributes$class('elm-input-datepickerAM');
										}
									}(),
									_1: {ctor: '[]'}
								}
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
									A4(_abadi199$datepicker$AnalogTimePickerPanel$amPmPickerHandler, config, _p60, currentDate, 'PM')),
								_1: {
									ctor: '::',
									_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
										A4(_abadi199$datepicker$AnalogTimePickerPanel$amPmPickerHandler, config, _p60, currentDate, 'PM')),
									_1: {
										...
										_0: function () {
											...
											if ((_p56.ctor === 'Just') && (_p56._0 === 'PM')) {
												return _elm_lang$html$Html_Attributes$class('elm-input-datepickerPM elm-input-datepickerSelectedAmPm');
											} else {
												return _elm_lang$html$Html_Attributes$class('elm-input-datepickerPM');
											}
										}(),
										_1: {ctor: '[]'}
									}
		...
		var isActive = function (timeIndicator) {
			return _elm_lang$core$Native_Utils.eq(
				...
				_elm_lang$core$Maybe$Just(timeIndicator)) ? 'elm-input-datepickerActive' : '';
		};
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerTimePickerDialog elm-input-datepickerAnalogTime'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerHeader'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
									A4(_abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler, config, _p60, currentDate, _abadi199$datepicker$DateTimePicker_Internal$HourIndicator)),
								_1: {
									ctor: '::',
									_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
										A4(_abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler, config, _p60, currentDate, _abadi199$datepicker$DateTimePicker_Internal$HourIndicator)),
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$class(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'elm-input-datepickerHour ',
												isActive(_abadi199$datepicker$DateTimePicker_Internal$HourIndicator))),
										_1: {ctor: '[]'}
									}
								}
							},
								...
								_0: _elm_lang$html$Html$text(
									A2(
										...
										A2(
											_elm_lang$core$Maybe$map,
											function (_p57) {
												return _abadi199$datepicker$DateTimePicker_DateUtils$padding(
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerSeparator'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$span,
									{
										ctor: '::',
										_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
											A4(_abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler, config, _p60, currentDate, _abadi199$datepicker$DateTimePicker_Internal$MinuteIndicator)),
										_1: {
											ctor: '::',
											_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
												A4(_abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler, config, _p60, currentDate, _abadi199$datepicker$DateTimePicker_Internal$MinuteIndicator)),
											_1: {
												...
												_0: _elm_lang$html$Html_Attributes$class(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'elm-input-datepickerMinute ',
														isActive(_abadi199$datepicker$DateTimePicker_Internal$MinuteIndicator))),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{
											ctor: '::',
											_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
												A4(_abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler, config, _p60, currentDate, _abadi199$datepicker$DateTimePicker_Internal$AMPMIndicator)),
											_1: {
												ctor: '::',
												_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
													A4(_abadi199$datepicker$AnalogTimePickerPanel$timeIndicatorHandler, config, _p60, currentDate, _abadi199$datepicker$DateTimePicker_Internal$AMPMIndicator)),
												_1: {
													...
													_0: _elm_lang$html$Html_Attributes$class(
														A2(
															_elm_lang$core$Basics_ops['++'],
															'elm-input-datepickerAMPM ',
															isActive(_abadi199$datepicker$DateTimePicker_Internal$AMPMIndicator))),
													_1: {ctor: '[]'}
												}
											}
										},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerBody'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: function () {
								...
								if ((_p59.ctor === 'Just') && (_p59._0.ctor === 'AMPMIndicator')) {
									...
									return A3(_abadi199$datepicker$AnalogTimePickerPanel$clock, config.onChange, _p60, currentDate);
								}
							}(),
							_1: {ctor: '[]'}
						}),
...
var _abadi199$datepicker$AnalogTimePickerPanel$Config = F2(
	function (a, b) {
		return {onChange: a, titleFormatter: b};
	});
...
var _abadi199$datepicker$DateTimePicker_Formatter$timePattern = '%I:%M %p';
var _abadi199$datepicker$DateTimePicker_Formatter$timeFormatter = A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$timePattern);
var _abadi199$datepicker$DateTimePicker_Formatter$dateTimePattern = '%m/%d/%Y %I:%M %p';
var _abadi199$datepicker$DateTimePicker_Formatter$dateTimeFormatter = A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$dateTimePattern);
var _abadi199$datepicker$DateTimePicker_Formatter$footerPattern = '%A, %B %d, %Y';
var _abadi199$datepicker$DateTimePicker_Formatter$footerFormatter = A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$footerPattern);
var _abadi199$datepicker$DateTimePicker_Formatter$datePattern = '%m/%d/%Y';
var _abadi199$datepicker$DateTimePicker_Formatter$dateFormatter = A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$datePattern);
var _abadi199$datepicker$DateTimePicker_Formatter$titlePattern = '%B %Y';
var _abadi199$datepicker$DateTimePicker_Formatter$titleFormatter = A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$titlePattern);

var _abadi199$datepicker$DateTimePicker_Config$defaultNameOfDays = {sunday: 'Su', monday: 'Mo', tuesday: 'Tu', wednesday: 'We', thursday: 'Th', friday: 'Fr', saturday: 'Sa'};
var _abadi199$datepicker$DateTimePicker_Config$defaultTimeInputFormat = {
	inputFormatter: _abadi199$datepicker$DateTimePicker_Formatter$timeFormatter,
	inputParser: function (input) {
		return _elm_lang$core$Result$toMaybe(
			A3(_abadi199$dateparser$DateParser$parse, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$timePattern, input));
	}
};
var _abadi199$datepicker$DateTimePicker_Config$defaultDateTimeInputFormat = {
	inputFormatter: _abadi199$datepicker$DateTimePicker_Formatter$dateTimeFormatter,
	inputParser: function (input) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			...
			A2(
				...
				_elm_lang$core$Result$toMaybe(
					A3(_abadi199$dateparser$DateParser$parse, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$dateTimePattern, input))));
	}
};
var _abadi199$datepicker$DateTimePicker_Config$defaultDateInputFormat = {
	inputFormatter: _abadi199$datepicker$DateTimePicker_Formatter$dateFormatter,
	inputParser: function (input) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Result$toMaybe(
			...
			A2(
				...
				_elm_lang$core$Maybe$Just,
				_elm_lang$core$Result$toMaybe(
					A3(_abadi199$dateparser$DateParser$parse, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$DateTimePicker_Formatter$datePattern, input))));
	}
};
var _abadi199$datepicker$DateTimePicker_Config$defaultDateTimeI18n = {titleFormatter: _abadi199$datepicker$DateTimePicker_Formatter$titleFormatter, footerFormatter: _abadi199$datepicker$DateTimePicker_Formatter$footerFormatter, timeTitleFormatter: _abadi199$datepicker$DateTimePicker_Formatter$timeFormatter, inputFormat: _abadi199$datepicker$DateTimePicker_Config$defaultDateTimeInputFormat};
var _abadi199$datepicker$DateTimePicker_Config$defaultTimeI18n = {titleFormatter: _abadi199$datepicker$DateTimePicker_Formatter$titleFormatter, footerFormatter: _abadi199$datepicker$DateTimePicker_Formatter$footerFormatter, timeTitleFormatter: _abadi199$datepicker$DateTimePicker_Formatter$timeFormatter, inputFormat: _abadi199$datepicker$DateTimePicker_Config$defaultTimeInputFormat};
var _abadi199$datepicker$DateTimePicker_Config$defaultDateI18n = {titleFormatter: _abadi199$datepicker$DateTimePicker_Formatter$titleFormatter, footerFormatter: _abadi199$datepicker$DateTimePicker_Formatter$footerFormatter, timeTitleFormatter: _abadi199$datepicker$DateTimePicker_Formatter$timeFormatter, inputFormat: _abadi199$datepicker$DateTimePicker_Config$defaultDateInputFormat};
var _abadi199$datepicker$DateTimePicker_Config$defaultDatePickerConfig = function (onChange) {
	return {
		onChange: onChange,
		autoClose: true,
		nameOfDays: _abadi199$datepicker$DateTimePicker_Config$defaultNameOfDays,
		firstDayOfWeek: _elm_lang$core$Date$Sun,
		allowYearNavigation: true,
		i18n: _abadi199$datepicker$DateTimePicker_Config$defaultDateI18n,
		usePicker: true,
		attributes: {ctor: '[]'}
	};
};
var _abadi199$datepicker$DateTimePicker_Config$I18n = F4(
	function (a, b, c, d) {
		return {titleFormatter: a, footerFormatter: b, timeTitleFormatter: c, inputFormat: d};
	});
var _abadi199$datepicker$DateTimePicker_Config$InputFormat = F2(
	function (a, b) {
		return {inputFormatter: a, inputParser: b};
	});
var _abadi199$datepicker$DateTimePicker_Config$TimePickerConfig = function (a) {
	return {timePickerType: a};
};
var _abadi199$datepicker$DateTimePicker_Config$NameOfDays = F7(
	function (a, b, c, d, e, f, g) {
		return {sunday: a, monday: b, tuesday: c, wednesday: d, thursday: e, friday: f, saturday: g};
	});
var _abadi199$datepicker$DateTimePicker_Config$TimeType = function (a) {
	return {ctor: 'TimeType', _0: a};
};
var _abadi199$datepicker$DateTimePicker_Config$DateTimeType = function (a) {
	return {ctor: 'DateTimeType', _0: a};
};
var _abadi199$datepicker$DateTimePicker_Config$DateType = function (a) {
	return {ctor: 'DateType', _0: a};
};
var _abadi199$datepicker$DateTimePicker_Config$Analog = {ctor: 'Analog'};
var _abadi199$datepicker$DateTimePicker_Config$defaultTimePickerConfig = function (onChange) {
	return {
		onChange: onChange,
		autoClose: false,
		timePickerType: _abadi199$datepicker$DateTimePicker_Config$Analog,
		i18n: _abadi199$datepicker$DateTimePicker_Config$defaultTimeI18n,
		usePicker: true,
		attributes: {ctor: '[]'}
	};
};
var _abadi199$datepicker$DateTimePicker_Config$defaultDateTimePickerConfig = function (onChange) {
	return {
		onChange: onChange,
		autoClose: false,
		nameOfDays: _abadi199$datepicker$DateTimePicker_Config$defaultNameOfDays,
		...
		timePickerType: _abadi199$datepicker$DateTimePicker_Config$Analog,
		allowYearNavigation: true,
		i18n: _abadi199$datepicker$DateTimePicker_Config$defaultDateTimeI18n,
		usePicker: true,
		attributes: {ctor: '[]'}
	};
};
var _abadi199$datepicker$DateTimePicker_Config$Digital = {ctor: 'Digital'};

var _abadi199$datepicker$DateTimePicker_Svg$doubleArrow = function (orientation) {
...
var _abadi199$datepicker$DateTimePicker_Svg$arrow = function (orientation) {
	var rotation = function () {
		var _p1 = orientation;
		switch (_p1.ctor) {
			case 'Right':
...
var _abadi199$datepicker$DateTimePicker_Svg$Right = {ctor: 'Right'};
var _abadi199$datepicker$DateTimePicker_Svg$rightArrow = _abadi199$datepicker$DateTimePicker_Svg$arrow(_abadi199$datepicker$DateTimePicker_Svg$Right);
var _abadi199$datepicker$DateTimePicker_Svg$Left = {ctor: 'Left'};
var _abadi199$datepicker$DateTimePicker_Svg$leftArrow = _abadi199$datepicker$DateTimePicker_Svg$arrow(_abadi199$datepicker$DateTimePicker_Svg$Left);
var _abadi199$datepicker$DateTimePicker_Svg$Down = {ctor: 'Down'};
var _abadi199$datepicker$DateTimePicker_Svg$downArrow = _abadi199$datepicker$DateTimePicker_Svg$arrow(_abadi199$datepicker$DateTimePicker_Svg$Down);
var _abadi199$datepicker$DateTimePicker_Svg$Up = {ctor: 'Up'};
var _abadi199$datepicker$DateTimePicker_Svg$upArrow = _abadi199$datepicker$DateTimePicker_Svg$arrow(_abadi199$datepicker$DateTimePicker_Svg$Up);
var _abadi199$datepicker$DateTimePicker_Svg$DoubleRight = {ctor: 'DoubleRight'};
var _abadi199$datepicker$DateTimePicker_Svg$doubleRightArrow = _abadi199$datepicker$DateTimePicker_Svg$doubleArrow(_abadi199$datepicker$DateTimePicker_Svg$DoubleRight);
var _abadi199$datepicker$DateTimePicker_Svg$DoubleLeft = {ctor: 'DoubleLeft'};
var _abadi199$datepicker$DateTimePicker_Svg$doubleLeftArrow = _abadi199$datepicker$DateTimePicker_Svg$doubleArrow(_abadi199$datepicker$DateTimePicker_Svg$DoubleLeft);
...
var _abadi199$datepicker$DatePickerPanel$dayNames = function (config) {
	var shiftAmount = A2(_abadi199$datepicker$DateTimePicker_DateUtils$dayToInt, _elm_lang$core$Date$Sun, config.firstDayOfWeek);
	var days = {
		ctor: '::',
		_0: A2(
...
var _abadi199$datepicker$DatePickerPanel$noYearNavigationClass = function (config) {
	return config.allowYearNavigation ? '' : 'elm-input-datepickerNoYearNavigation';
};
var _abadi199$datepicker$DatePickerPanel$gotoPreviousYear = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3._0;
...
var _abadi199$datepicker$DatePickerPanel$previousYearButton = F3(
	function (config, state, currentDate) {
		return config.allowYearNavigation ? A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerDoubleArrowLeft'),
				_1: {
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A2(
							config.onChange,
							_abadi199$datepicker$DatePickerPanel$gotoPreviousYear(state),
							currentDate)),
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
			...
			{
				ctor: '::',
				_0: _abadi199$datepicker$DateTimePicker_Svg$doubleLeftArrow,
				_1: {ctor: '[]'}
			}) : _elm_lang$html$Html$text('');
	});
var _abadi199$datepicker$DatePickerPanel$gotoPreviousMonth = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6._0;
	var updatedTitleDate = A2(
		_elm_lang$core$Maybe$map,
...
var _abadi199$datepicker$DatePickerPanel$previousButton = F3(
	function (config, state, currentDate) {
		return A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'elm-input-datepickerArrowLeft ',
						_abadi199$datepicker$DatePickerPanel$noYearNavigationClass(config))),
				_1: {
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A2(
							config.onChange,
							_abadi199$datepicker$DatePickerPanel$gotoPreviousMonth(state),
							currentDate)),
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
			...
			{
				ctor: '::',
				_0: _abadi199$datepicker$DateTimePicker_Svg$leftArrow,
				_1: {ctor: '[]'}
			});
	});
var _abadi199$datepicker$DatePickerPanel$gotoNextYear = function (_p8) {
	var _p9 = _p8;
	var _p10 = _p9._0;
	var updatedTitleDate = A2(
		_elm_lang$core$Maybe$map,
...
var _abadi199$datepicker$DatePickerPanel$nextYearButton = F3(
	function (config, state, currentDate) {
		return config.allowYearNavigation ? A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerDoubleArrowRight'),
				_1: {
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A2(
							config.onChange,
							_abadi199$datepicker$DatePickerPanel$gotoNextYear(state),
							currentDate)),
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
			...
			{
				ctor: '::',
				_0: _abadi199$datepicker$DateTimePicker_Svg$doubleRightArrow,
				_1: {ctor: '[]'}
			}) : _elm_lang$html$Html$text('');
	});
var _abadi199$datepicker$DatePickerPanel$gotoNextMonth = function (_p11) {
	var _p12 = _p11;
	var _p13 = _p12._0;
	var updatedTitleDate = A2(
		_elm_lang$core$Maybe$map,
...
var _abadi199$datepicker$DatePickerPanel$nextButton = F3(
	function (config, state, currentDate) {
		return A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'elm-input-datepickerArrowRight ',
						_abadi199$datepicker$DatePickerPanel$noYearNavigationClass(config))),
				_1: {
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A2(
							config.onChange,
							_abadi199$datepicker$DatePickerPanel$gotoNextMonth(state),
							currentDate)),
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
			...
			{
				ctor: '::',
				_0: _abadi199$datepicker$DateTimePicker_Svg$rightArrow,
				_1: {ctor: '[]'}
			});
	});
var _abadi199$datepicker$DatePickerPanel$dateClickHandler = F5(
	function (config, _p14, year, month, day) {
		var _p15 = _p14;
		var _p17 = _p15._0;
		var selectedDate = _elm_lang$core$Maybe$Just(
			A3(_abadi199$datepicker$DateTimePicker_DateUtils$toDate, year, month, day));
		var updatedState = _abadi199$datepicker$DateTimePicker_Internal$InternalState(
			_elm_lang$core$Native_Utils.update(
				_p17,
				{
					date: selectedDate,
					forceClose: true,
					activeTimeIndicator: _elm_lang$core$Native_Utils.eq(_p17.time.hour, _elm_lang$core$Maybe$Nothing) ? _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$HourIndicator) : (_elm_lang$core$Native_Utils.eq(_p17.time.minute, _elm_lang$core$Maybe$Nothing) ? _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$MinuteIndicator) : (_elm_lang$core$Native_Utils.eq(_p17.time.amPm, _elm_lang$core$Maybe$Nothing) ? _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$AMPMIndicator) : _elm_lang$core$Maybe$Nothing))
				}));
		...
		switch (_p16.ctor) {
			case 'Previous':
				return A2(
					config.onChange,
					_abadi199$datepicker$DatePickerPanel$gotoPreviousMonth(updatedState),
					selectedDate);
			case 'Next':
				return A2(
					config.onChange,
					_abadi199$datepicker$DatePickerPanel$gotoNextMonth(updatedState),
					selectedDate);
			default:
				return A2(config.onChange, updatedState, selectedDate);
		}
	});
var _abadi199$datepicker$DatePickerPanel$calendar = F3(
	function (config, _p18, currentDate) {
		...
		if (_p20.ctor === 'Nothing') {
			...
			var header = A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerDaysOfWeek'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						_abadi199$datepicker$DatePickerPanel$dayNames(config)),
					_1: {ctor: '[]'}
				});
			var year = _elm_lang$core$Date$year(_p22);
			var month = _elm_lang$core$Date$month(_p22);
			var days = A3(_abadi199$datepicker$DateTimePicker_DateUtils$generateCalendar, config.firstDayOfWeek, month, year);
			...
			var toCell = function (day) {
				var selectedDate = A3(_abadi199$datepicker$DateTimePicker_DateUtils$toDate, year, month, day);
				return A2(
					_elm_lang$html$Html$td,
					{
						...
						_0: _elm_lang$html$Html_Attributes$class(
							function () {
								...
								switch (_p21.ctor) {
									case 'Previous':
										return 'elm-input-datepickerPreviousMonth';
									case 'Current':
										return A2(
											_elm_lang$core$Basics_ops['++'],
											'elm-input-datepickerCurrentMonth ',
											isHighlighted(day) ? 'elm-input-datepickerSelectedDate' : (isToday(day) ? 'elm-input-datepickerToday' : ''));
									default:
										return 'elm-input-datepickerNextMonth';
								}
							}()),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
										A5(
											_abadi199$datepicker$DatePickerPanel$dateClickHandler,
											config,
											_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p23),
											year,
											month,
											day)),
									_1: {
			...
			var body = A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerDays'),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$List$map,
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerCalendar'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _abadi199$datepicker$DatePickerPanel$switchMode = function (_p24) {
	var _p25 = _p24;
	return _abadi199$datepicker$DateTimePicker_Internal$InternalState(
		_elm_lang$core$Native_Utils.update(
			_p25._0,
...
var _abadi199$datepicker$DatePickerPanel$title = F3(
	function (config, _p26, currentDate) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerTitle'),
				_1: {
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A2(
							config.onChange,
							_abadi199$datepicker$DatePickerPanel$switchMode(_p27),
							currentDate)),
					_1: {ctor: '[]'}
				}
			},
...
var _abadi199$datepicker$DatePickerPanel$navigation = F3(
	function (config, state, currentDate) {
		return {
			ctor: '::',
			_0: A3(_abadi199$datepicker$DatePickerPanel$previousYearButton, config, state, currentDate),
			_1: {
				ctor: '::',
				_0: A3(_abadi199$datepicker$DatePickerPanel$previousButton, config, state, currentDate),
				_1: {
					ctor: '::',
					_0: A3(_abadi199$datepicker$DatePickerPanel$title, config, state, currentDate),
					_1: {
						ctor: '::',
						_0: A3(_abadi199$datepicker$DatePickerPanel$nextButton, config, state, currentDate),
						_1: {
							ctor: '::',
							_0: A3(_abadi199$datepicker$DatePickerPanel$nextYearButton, config, state, currentDate),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _abadi199$datepicker$DatePickerPanel$view = F3(
	function (config, _p28, currentDate) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerDatePickerDialog'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					A3(_abadi199$datepicker$DatePickerPanel$navigation, config, _p30, currentDate)),
				_1: {
					ctor: '::',
					_0: A3(_abadi199$datepicker$DatePickerPanel$calendar, config, _p30, currentDate),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerFooter'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _abadi199$datepicker$DatePickerPanel$Config = F6(
	function (a, b, c, d, e, f) {
		return {onChange: a, nameOfDays: b, firstDayOfWeek: c, allowYearNavigation: d, titleFormatter: e, footerFormatter: f};
	});

var _abadi199$datepicker$DigitalTimePickerPanel$minuteDownHandler = F3(
...
var _abadi199$datepicker$DigitalTimePickerPanel$minuteUpHandler = F3(
...
var _abadi199$datepicker$DigitalTimePickerPanel$hourDownHandler = F3(
...
var _abadi199$datepicker$DigitalTimePickerPanel$hourUpHandler = F3(
...
var _abadi199$datepicker$DigitalTimePickerPanel$amPmClickHandler = F3(
	function (config, _p12, amPm) {
			...
			if (((_p15.ctor === '_Tuple2') && (_p15._0.ctor === 'Just')) && (_p15._1.ctor === 'Just')) {
				return {
					...
					_0: _elm_lang$core$Maybe$Just(
						A3(_abadi199$datepicker$DateTimePicker_DateUtils$toTime, _p15._0._0, _p15._1._0, amPm)),
					_1: true
				};
			} else {
		...
		return A2(
			config.onChange,
			_abadi199$datepicker$DateTimePicker_Internal$InternalState(
				_elm_lang$core$Native_Utils.update(
					updatedStateValue,
					{forceClose: forceClose})),
			updatedTime);
	});
var _abadi199$datepicker$DigitalTimePickerPanel$minuteClickHandler = F3(
		...
		var _p19 = function () {
			...
			if (((_p20.ctor === '_Tuple2') && (_p20._0.ctor === 'Just')) && (_p20._1.ctor === 'Just')) {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Just(
						A3(_abadi199$datepicker$DateTimePicker_DateUtils$toTime, _p20._0._0, minute, _p20._1._0)),
					_1: true
				};
			} else {
				return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: false};
...
var _abadi199$datepicker$DigitalTimePickerPanel$hourClickHandler = F3(
		...
		var _p24 = function () {
			...
			if (((_p25.ctor === '_Tuple2') && (_p25._0.ctor === 'Just')) && (_p25._1.ctor === 'Just')) {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Just(
						A3(_abadi199$datepicker$DateTimePicker_DateUtils$toTime, hour, _p25._0._0, _p25._1._0)),
					_1: true
				};
			} else {
				return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: false};
...
var _abadi199$datepicker$DigitalTimePickerPanel$view = F3(
	function (config, _p27, currentDate) {
		...
		var downArrows = function (config) {
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerArrowDown'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$td,
							{
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
									A3(_abadi199$datepicker$DigitalTimePickerPanel$hourDownHandler, config, _p31, currentDate)),
								_1: {
									ctor: '::',
									_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
										A3(_abadi199$datepicker$DigitalTimePickerPanel$hourDownHandler, config, _p31, currentDate)),
							...
							{
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Svg$downArrow,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$td,
								{
									ctor: '::',
									_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
										A3(_abadi199$datepicker$DigitalTimePickerPanel$minuteDownHandler, config, _p31, currentDate)),
									_1: {
										ctor: '::',
										_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
											A3(_abadi199$datepicker$DigitalTimePickerPanel$minuteDownHandler, config, _p31, currentDate)),
		...
		var upArrows = function (config) {
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerArrowUp'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$td,
							{
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
									A3(_abadi199$datepicker$DigitalTimePickerPanel$hourUpHandler, config, _p31, currentDate)),
								_1: {
									ctor: '::',
									_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
										A3(_abadi199$datepicker$DigitalTimePickerPanel$hourUpHandler, config, _p31, currentDate)),
							...
							{
								ctor: '::',
								_0: _abadi199$datepicker$DateTimePicker_Svg$upArrow,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$td,
								{
									ctor: '::',
									_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
										A3(_abadi199$datepicker$DigitalTimePickerPanel$minuteUpHandler, config, _p31, currentDate)),
									_1: {
										ctor: '::',
										_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
											A3(_abadi199$datepicker$DigitalTimePickerPanel$minuteUpHandler, config, _p31, currentDate)),
		...
		var amPmCell = function (ampm) {
			var defaultClasses = _elm_lang$html$Html_Attributes$class(
				_elm_lang$core$Native_Utils.eq(ampm, '') ? 'elm-input-datepickerEmptyCell' : '');
			return A2(
				_elm_lang$html$Html$td,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Maybe$map,
								function (selected) {
									return selected ? _elm_lang$html$Html_Attributes$class('SelectedAmPm') : defaultClasses;
								},
								A2(
									_elm_lang$core$Maybe$map,
									F2(
					...
					_elm_lang$core$Native_Utils.eq(ampm, '') ? {ctor: '[]'} : {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
							A3(_abadi199$datepicker$DigitalTimePickerPanel$amPmClickHandler, config, _p31, ampm)),
						_1: {
							ctor: '::',
							_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
								A3(_abadi199$datepicker$DigitalTimePickerPanel$amPmClickHandler, config, _p31, ampm)),
		...
		var minuteCell = function (min) {
			return A2(
				_elm_lang$html$Html$td,
				{
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A3(_abadi199$datepicker$DigitalTimePickerPanel$minuteClickHandler, config, _p31, min)),
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
							A3(_abadi199$datepicker$DigitalTimePickerPanel$minuteClickHandler, config, _p31, min)),
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$Maybe$map,
									function (selected) {
										return selected ? _elm_lang$html$Html_Attributes$class('elm-input-datepickerSelectedMinute') : _elm_lang$html$Html_Attributes$class('');
									},
									A2(
										_elm_lang$core$Maybe$map,
										F2(
		...
		var hourCell = function (hour) {
			return A2(
				_elm_lang$html$Html$td,
				{
					ctor: '::',
					_0: _abadi199$datepicker$DateTimePicker_Events$onMouseDownPreventDefault(
						A3(_abadi199$datepicker$DigitalTimePickerPanel$hourClickHandler, config, _p31, hour)),
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$DateTimePicker_Events$onTouchStartPreventDefault(
							A3(_abadi199$datepicker$DigitalTimePickerPanel$hourClickHandler, config, _p31, hour)),
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$Maybe$map,
									function (selected) {
										return selected ? _elm_lang$html$Html_Attributes$class('elm-input-datepickerSelectedHour') : _elm_lang$html$Html_Attributes$class('');
									},
									A2(
										_elm_lang$core$Maybe$map,
										F2(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerTimePickerDialog elm-input-datepickerDigitalTime'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _abadi199$datepicker$DigitalTimePickerPanel$Config = F2(
	function (a, b) {
		return {onChange: a, titleFormatter: b};
	});

var _abadi199$datepicker$MultiPanel$view = F4(
	function (dateConfig, _p0, state, currentDate) {
		...
		var safeOnChange = F2(
			function (_p3, _p2) {
				...
				return A2(
					dateConfig.onChange,
					_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p6),
					function () {
						var _p5 = {ctor: '_Tuple4', _0: _p6.date, _1: _p6.time.hour, _2: _p6.time.minute, _3: _p6.time.amPm};
						if (((((_p5.ctor === '_Tuple4') && (_p5._0.ctor === 'Just')) && (_p5._1.ctor === 'Just')) && (_p5._2.ctor === 'Just')) && (_p5._3.ctor === 'Just')) {
							return _elm_lang$core$Maybe$Just(
								A4(_abadi199$datepicker$DateTimePicker_DateUtils$setTime, _p5._0._0, _p5._1._0, _p5._2._0, _p5._3._0));
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					}());
		...
		return {
			ctor: '::',
			_0: A3(_abadi199$datepicker$DatePickerPanel$view, safeDateConfig, state, currentDate),
			_1: {
				ctor: '::',
				_0: function () {
					var _p7 = _p1._0;
					if (_p7.ctor === 'Digital') {
						return A3(_abadi199$datepicker$DigitalTimePickerPanel$view, safeTimeConfig, state, currentDate);
					} else {
						return A3(_abadi199$datepicker$AnalogTimePickerPanel$view, safeTimeConfig, state, currentDate);
					}
				}(),
				_1: {ctor: '[]'}
			}
...
var _abadi199$datepicker$DateTimePicker$onChangeHandler = F3(
		...
		var withTimeHandler = function (config) {
			...
			if (((((_p2.ctor === '_Tuple4') && (_p2._0.ctor === 'Just')) && (_p2._1.ctor === 'Just')) && (_p2._2.ctor === 'Just')) && (_p2._3.ctor === 'Just')) {
				return A2(
					...
					_p4,
					_elm_lang$core$Maybe$Just(
						A4(_abadi199$datepicker$DateTimePicker_DateUtils$setTime, _p2._0._0, _p2._1._0, _p2._2._0, _p2._3._0)));
			} else {
...
var _abadi199$datepicker$DateTimePicker$datePickerFocused = F4(
			...
			return _elm_lang$core$Native_Utils.update(
				time,
				{
					hour: A2(
						_elm_lang$core$Maybe$map,
						function (_p8) {
							return _abadi199$datepicker$DateTimePicker_DateUtils$fromMillitaryHour(
					...
					amPm: A2(
						_elm_lang$core$Maybe$map,
						function (_p9) {
							return _abadi199$datepicker$DateTimePicker_DateUtils$fromMillitaryAmPm(
...
var _abadi199$datepicker$DateTimePicker$dialog = F3(
	function (pickerType, _p13, currentDate) {
		...
		var attributes = function (config) {
			return {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('elm-input-datepickerDialog'),
					_1: {ctor: '[]'}
				}
			};
		};
				...
				if (_p15.ctor === 'Analog') {
					return {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							A3(
								_abadi199$datepicker$DateTimePicker$onChangeHandler,
								pickerType,
								_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p21),
								currentDate)),
		...
		switch (_p16.ctor) {
			case 'DateType':
				...
				return A2(
					...
					attributes(_p17),
					{
						ctor: '::',
						_0: A3(
							_abadi199$datepicker$DatePickerPanel$view,
							{onChange: _p17.onChange, nameOfDays: _p17.nameOfDays, firstDayOfWeek: _p17.firstDayOfWeek, allowYearNavigation: _p17.allowYearNavigation, titleFormatter: _p17.i18n.titleFormatter, footerFormatter: _p17.i18n.footerFormatter},
							_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p21),
							currentDate),
						_1: {ctor: '[]'}
					});
			case 'TimeType':
				...
				var dialog = function () {
					...
					if (_p18.ctor === 'Digital') {
						return _abadi199$datepicker$DigitalTimePickerPanel$view;
					} else {
						return _abadi199$datepicker$AnalogTimePickerPanel$view;
					}
				}();
				return A2(
					_elm_lang$html$Html$div,
					A2(withTimeAttributes, _p19, _p19.timePickerType),
					{
						...
						_0: A3(
							dialog,
							{onChange: _p19.onChange, titleFormatter: _p19.i18n.timeTitleFormatter},
							_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p21),
							currentDate),
						_1: {ctor: '[]'}
					});
			default:
				...
				return A2(
					...
					A4(
						_abadi199$datepicker$MultiPanel$view,
						{onChange: _p20.onChange, nameOfDays: _p20.nameOfDays, firstDayOfWeek: _p20.firstDayOfWeek, allowYearNavigation: _p20.allowYearNavigation, titleFormatter: _p20.i18n.titleFormatter, footerFormatter: _p20.i18n.footerFormatter},
						{
							ctor: '_Tuple2',
							_0: _p20.timePickerType,
							_1: {onChange: _p20.onChange, titleFormatter: _p20.i18n.timeTitleFormatter}
						},
						_abadi199$datepicker$DateTimePicker_Internal$InternalState(_p21),
						currentDate));
		}
	});
var _abadi199$datepicker$DateTimePicker$initialCmd = F2(
...
var _abadi199$datepicker$DateTimePicker$initialStateWithToday = function (today) {
	return _abadi199$datepicker$DateTimePicker_Internal$initialStateWithToday(today);
};
var _abadi199$datepicker$DateTimePicker$initialState = _abadi199$datepicker$DateTimePicker_Internal$initialState;
var _abadi199$datepicker$DateTimePicker$inputChangeHandler = F4(
	function (config, _p25, currentDate, maybeDate) {
		var _p26 = _p25;
		var _p32 = _p26._0;
		var _p27 = _abadi199$datepicker$DateTimePicker$initialState;
		...
		if (_p28.ctor === 'Just') {
				...
				return _elm_lang$core$Native_Utils.update(
					time,
					{
						hour: _elm_lang$core$Maybe$Just(
							_abadi199$datepicker$DateTimePicker_DateUtils$fromMillitaryHour(
						...
						amPm: _elm_lang$core$Maybe$Just(
							_abadi199$datepicker$DateTimePicker_DateUtils$fromMillitaryAmPm(
								_elm_lang$core$Date$hour(_p29)))
					});
			};
			...
			return A2(
				config.onChange,
				_abadi199$datepicker$DateTimePicker_Internal$InternalState(updatedValue),
				maybeDate);
		} else {
			var _p30 = function () {
				...
				if (_p31.ctor === 'Just') {
					return {
						...
						_1: _elm_lang$core$Maybe$Just(_abadi199$datepicker$DateTimePicker_Internal$HourIndicator),
...
var _abadi199$datepicker$DateTimePicker$view = F4(
	function (pickerType, attributes, _p33, currentDate) {
		var _p34 = _p33;
		var _p37 = _p34._0;
		var _p36 = _p34;
		var shouldForceClose = function (config) {
			return config.autoClose && _p37.forceClose;
		};
			...
			return A2(
				...
				attributes,
				{
					...
					_0: _elm_lang$html$Html_Events$onFocus(
						A4(_abadi199$datepicker$DateTimePicker$datePickerFocused, pickerType, config, _p36, currentDate)),
					_1: {
						ctor: '::',
						_0: A2(
							_abadi199$datepicker$DateTimePicker_Events$onBlurWithChange,
							config.i18n.inputFormat.inputParser,
							A3(_abadi199$datepicker$DateTimePicker$inputChangeHandler, config, _p36, currentDate)),
						_1: {
							ctor: '::',
			...
			function (config, cssClasses) {
				return A2(
					...
					{ctor: '::', _0: cssClasses, _1: config.attributes},
					{
						...
						_1: {
							ctor: '::',
							_0: (config.usePicker && (_p37.inputFocused && (!shouldForceClose(config)))) ? A3(_abadi199$datepicker$DateTimePicker$dialog, pickerType, _p36, currentDate) : _elm_lang$html$Html$text(''),
							_1: {ctor: '[]'}
						}
					});
			});
		...
		switch (_p35.ctor) {
			case 'DateType':
				return A2(
					html,
					_p35._0,
					_elm_lang$html$Html_Attributes$class('elm-input-datepickerDatePicker'));
			case 'DateTimeType':
				return A2(
					html,
					_p35._0,
					_elm_lang$html$Html_Attributes$class('elm-input-datepickerDatePicker elm-input-datepickerTimePicker'));
			default:
				return A2(
					html,
					_p35._0,
					_elm_lang$html$Html_Attributes$class('elm-input-datepickerTimePicker'));
		}
	});
var _abadi199$datepicker$DateTimePicker$datePickerWithConfig = function (config) {
	return _abadi199$datepicker$DateTimePicker$view(
		_abadi199$datepicker$DateTimePicker_Config$DateType(config));
};
var _abadi199$datepicker$DateTimePicker$datePicker = function (onChange) {
	return _abadi199$datepicker$DateTimePicker$datePickerWithConfig(
		_abadi199$datepicker$DateTimePicker_Config$defaultDatePickerConfig(onChange));
};
var _abadi199$datepicker$DateTimePicker$dateTimePickerWithConfig = function (config) {
	return _abadi199$datepicker$DateTimePicker$view(
		_abadi199$datepicker$DateTimePicker_Config$DateTimeType(config));
};
var _abadi199$datepicker$DateTimePicker$dateTimePicker = function (onChange) {
	return _abadi199$datepicker$DateTimePicker$dateTimePickerWithConfig(
		_abadi199$datepicker$DateTimePicker_Config$defaultDateTimePickerConfig(onChange));
};
var _abadi199$datepicker$DateTimePicker$timePickerWithConfig = function (config) {
	return _abadi199$datepicker$DateTimePicker$view(
		_abadi199$datepicker$DateTimePicker_Config$TimeType(config));
};
var _abadi199$datepicker$DateTimePicker$timePicker = function (onChange) {
	return _abadi199$datepicker$DateTimePicker$timePickerWithConfig(
		_abadi199$datepicker$DateTimePicker_Config$defaultTimePickerConfig(onChange));
};

var _abadi199$datepicker$Demo$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p2 = _p0._0;
		return {
...
var _abadi199$datepicker$Demo$customDatePattern = '%d/%m/%Y %H:%M';
var _abadi199$datepicker$Demo$customInputFormat = {
	inputFormatter: A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$Demo$customDatePattern),
	inputParser: function (_p3) {
		return _elm_lang$core$Result$toMaybe(
			A3(_abadi199$dateparser$DateParser$parse, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _abadi199$datepicker$Demo$customDatePattern, _p3));
	}
};
var _abadi199$datepicker$Demo$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _abadi199$datepicker$Demo$Model = F2(
	function (a, b) {
		return {dates: a, datePickerState: b};
	});
var _abadi199$datepicker$Demo$NoPicker = {ctor: 'NoPicker'};
var _abadi199$datepicker$Demo$TimePicker = {ctor: 'TimePicker'};
var _abadi199$datepicker$Demo$CustomI18n = {ctor: 'CustomI18n'};
var _abadi199$datepicker$Demo$AnalogDateTimePicker = {ctor: 'AnalogDateTimePicker'};
var _abadi199$datepicker$Demo$DigitalDateTimePicker = {ctor: 'DigitalDateTimePicker'};
var _abadi199$datepicker$Demo$DatePicker = {ctor: 'DatePicker'};
var _abadi199$datepicker$Demo$DatePickerChanged = F3(
	function (a, b, c) {
		return {ctor: 'DatePickerChanged', _0: a, _1: b, _2: c};
	});
var _abadi199$datepicker$Demo$init = {
	ctor: '_Tuple2',
	_0: {dates: _elm_lang$core$Dict$empty, datePickerState: _elm_lang$core$Dict$empty},
	_1: _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: A2(
				_abadi199$datepicker$DateTimePicker$initialCmd,
				_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$DatePicker),
				_abadi199$datepicker$DateTimePicker$initialState),
			_1: {
				ctor: '::',
				_0: A2(
					_abadi199$datepicker$DateTimePicker$initialCmd,
					_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$DigitalDateTimePicker),
					_abadi199$datepicker$DateTimePicker$initialState),
				_1: {
					ctor: '::',
					_0: A2(
						_abadi199$datepicker$DateTimePicker$initialCmd,
						_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$AnalogDateTimePicker),
						_abadi199$datepicker$DateTimePicker$initialState),
					_1: {
						ctor: '::',
						_0: A2(
							_abadi199$datepicker$DateTimePicker$initialCmd,
							_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$CustomI18n),
							_abadi199$datepicker$DateTimePicker$initialState),
						_1: {
							ctor: '::',
							_0: A2(
								_abadi199$datepicker$DateTimePicker$initialCmd,
								_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$TimePicker),
								_abadi199$datepicker$DateTimePicker$initialState),
							_1: {
								ctor: '::',
								_0: A2(
									_abadi199$datepicker$DateTimePicker$initialCmd,
									_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$NoPicker),
									_abadi199$datepicker$DateTimePicker$initialState),
								_1: {ctor: '[]'}
							}
						}
...
var _abadi199$datepicker$Demo$analogDateTimePickerConfig = function () {
	var defaultDateTimeConfig = _abadi199$datepicker$DateTimePicker_Config$defaultDateTimePickerConfig(
		_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$AnalogDateTimePicker));
	return _elm_lang$core$Native_Utils.update(
		defaultDateTimeConfig,
		{timePickerType: _abadi199$datepicker$DateTimePicker_Config$Analog, allowYearNavigation: false});
}();
var _abadi199$datepicker$Demo$timePickerConfig = function () {
	var defaultDateTimeConfig = _abadi199$datepicker$DateTimePicker_Config$defaultTimePickerConfig(
		_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$TimePicker));
	return _elm_lang$core$Native_Utils.update(
		defaultDateTimeConfig,
		{timePickerType: _abadi199$datepicker$DateTimePicker_Config$Analog});
}();
var _abadi199$datepicker$Demo$noPickerConfig = function () {
	var defaultDateConfig = _abadi199$datepicker$DateTimePicker_Config$defaultDatePickerConfig(
		_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$NoPicker));
	return _elm_lang$core$Native_Utils.update(
		defaultDateConfig,
		{
...
var _abadi199$datepicker$Demo$customI18nConfig = function () {
	var defaultDateTimeConfig = _abadi199$datepicker$DateTimePicker_Config$defaultDateTimePickerConfig(
		_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$CustomI18n));
	return _elm_lang$core$Native_Utils.update(
		defaultDateTimeConfig,
		{
			...
			i18n: _elm_lang$core$Native_Utils.update(
				_abadi199$datepicker$DateTimePicker_Config$defaultDateTimeI18n,
				{inputFormat: _abadi199$datepicker$Demo$customInputFormat})
		});
}();
var _abadi199$datepicker$Demo$digitalDateTimePickerConfig = function () {
	var defaultDateTimeConfig = _abadi199$datepicker$DateTimePicker_Config$defaultDateTimePickerConfig(
		_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$DigitalDateTimePicker));
	return _elm_lang$core$Native_Utils.update(
		defaultDateTimeConfig,
		{timePickerType: _abadi199$datepicker$DateTimePicker_Config$Digital});
}();
var _abadi199$datepicker$Demo$digitalTimePickerConfig = function () {
	var defaultDateTimeConfig = _abadi199$datepicker$DateTimePicker_Config$defaultTimePickerConfig(
		_abadi199$datepicker$Demo$DatePickerChanged(_abadi199$datepicker$Demo$TimePicker));
	return _elm_lang$core$Native_Utils.update(
		defaultDateTimeConfig,
...
var _abadi199$datepicker$Demo$viewPicker = F3(
	function (which, date, state) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(which)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(':'),
							_1: {
								...
								_0: function () {
									...
									switch (_p4.ctor) {
										case 'DatePicker':
											return A4(
												_abadi199$datepicker$DateTimePicker$datePicker,
												_abadi199$datepicker$Demo$DatePickerChanged(which),
												{ctor: '[]'},
												state,
												date);
										case 'DigitalDateTimePicker':
											return A4(
												_abadi199$datepicker$DateTimePicker$dateTimePickerWithConfig,
												_abadi199$datepicker$Demo$digitalDateTimePickerConfig,
												{ctor: '[]'},
												state,
												date);
										case 'AnalogDateTimePicker':
											return A4(
												_abadi199$datepicker$DateTimePicker$dateTimePickerWithConfig,
												_abadi199$datepicker$Demo$analogDateTimePickerConfig,
												{ctor: '[]'},
												state,
												date);
										case 'CustomI18n':
											return A4(
												_abadi199$datepicker$DateTimePicker$dateTimePickerWithConfig,
												_abadi199$datepicker$Demo$customI18nConfig,
												{ctor: '[]'},
												state,
												date);
										case 'TimePicker':
											return A4(
												_abadi199$datepicker$DateTimePicker$timePickerWithConfig,
												_abadi199$datepicker$Demo$digitalTimePickerConfig,
												{ctor: '[]'},
												state,
												date);
										default:
											return A4(
												_abadi199$datepicker$DateTimePicker$datePickerWithConfig,
												_abadi199$datepicker$Demo$noPickerConfig,
												{ctor: '[]'},
												state,
												date);
									}
...
var _abadi199$datepicker$Demo$view = function (model) {
	var allPickers = {
		ctor: '::',
		_0: _abadi199$datepicker$Demo$DatePicker,
		_1: {
			ctor: '::',
			_0: _abadi199$datepicker$Demo$DigitalDateTimePicker,
			_1: {
				ctor: '::',
				_0: _abadi199$datepicker$Demo$AnalogDateTimePicker,
				_1: {
					ctor: '::',
					_0: _abadi199$datepicker$Demo$CustomI18n,
					_1: {
						ctor: '::',
						_0: _abadi199$datepicker$Demo$TimePicker,
						_1: {
							ctor: '::',
							_0: _abadi199$datepicker$Demo$NoPicker,
							_1: {ctor: '[]'}
						}
					}
				}
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					...
					function (which) {
						return A3(
							_abadi199$datepicker$Demo$viewPicker,
							which,
							A2(
								_elm_lang$core$Dict$get,
								_elm_lang$core$Basics$toString(which),
...
var _abadi199$datepicker$Demo$main = _elm_lang$html$Html$program(
	{init: _abadi199$datepicker$Demo$init, update: _abadi199$datepicker$Demo$update, view: _abadi199$datepicker$Demo$view, subscriptions: _abadi199$datepicker$Demo$subscriptions})();

var Elm = {};
Elm['Demo'] = Elm['Demo'] || {};
if (typeof _abadi199$datepicker$Demo$main !== 'undefined') {
    _abadi199$datepicker$Demo$main(Elm['Demo'], 'Demo', undefined);
}
