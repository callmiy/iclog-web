...
view pickerType attributes ((InternalState stateValue) as state) currentDate =
    ...
    in
        case pickerType of
            DateType config ->
                html config (class "elm-input-datepickerDatePicker")

            DateTimeType config ->
                html config (class "elm-input-datepickerDatePicker elm-input-datepickerTimePicker")

            TimeType config ->
                html config (class "elm-input-datepickerTimePicker")
...
dialog pickerType (InternalState state) currentDate =
    let
        attributes config =
            ...
            , class "elm-input-datepickerDialog"
            ]
