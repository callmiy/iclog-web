    ...
    let
        isActive timeIndicator =
            if stateValue.activeTimeIndicator == Just timeIndicator then
                "elm-input-datepickerActive"
            else
                ""

        amPmPicker config =
            div [ class "elm-input-datepickerAMPMPicker" ]
                [ div
                    ...
                    , case stateValue.time.amPm of
                        Just "AM" ->
                            class "elm-input-datepickerAM elm-input-datepickerSelectedAmPm"

                        _ ->
                            class "elm-input-datepickerAM"
                    ]
                    [ Html.text "AM" ]
                , div
                    ...
                    , case stateValue.time.amPm of
                        Just "PM" ->
                            class "elm-input-datepickerPM elm-input-datepickerSelectedAmPm"

                        _ ->
                            class "elm-input-datepickerPM"
                    ]
                    [ Html.text "PM" ]
                ]
    in
        div [ class "elm-input-datepickerTimePickerDialog elm-input-datepickerAnalogTime" ]
            [ div [ class "elm-input-datepickerHeader" ]
                [ span
                    ...
                    , class
                        ("elm-input-datepickerHour " ++ isActive DateTimePicker.Internal.HourIndicator)
                    ]
                    [ Html.text (stateValue.time.hour |> Maybe.map (toString >> DateTimePicker.DateUtils.padding) |> Maybe.withDefault "--") ]
                , span [ class "elm-input-datepickerSeparator" ] [ Html.text " : " ]
                , span
                    ...
                    , class ("elm-input-datepickerMinute " ++ isActive DateTimePicker.Internal.MinuteIndicator)
                    ]
                ...
                , span
                    ...
                    , class ("elm-input-datepickerAMPM " ++ isActive DateTimePicker.Internal.AMPMIndicator)
                    ]
                    [ Html.text (stateValue.time.amPm |> Maybe.withDefault "--") ]
                ]
            , div [ class "elm-input-datepickerBody" ]
...
clock onChange ((InternalState stateValue) as state) date =
    div
        [ class "elm-input-datepickerAnalogClock"
        ]
        [ svg
            [ width "200"
            , height "200"
